...
- Зайдите на web интерфес установленного SUSE Rancher используя адрес указанный при render шаблона Rancher.
- Создайте RKE/RKE2 кластер используя web интерфейс.
- Убедитесь, что при создании у Вас указанна настройка Registry.
#### Cloud Init 
